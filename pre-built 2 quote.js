...
*/
    "Please find quote as requested\n" +
      ...
      "\n" +
      line +
      space + (e.field("type.") || "Product") + "1 DETAILS" +
      line +
      "\n" +
      ...
      "\n" +
      line +
      space + (e.field("type.") || "Product") + "2 DETAILS" +
      line +
      "\n" +
      "Brand: " + (e.field("brand2") || "Not specified") + "\n" +
      "CPU: " + (e.field("cpu2") || "Not specified") + "\n" +
      "Screen Size: " + (e.field("screen2") || "Not specified") + "\n" +
      "Ram: " + (e.field("ram2") || "Not specified") + "\n" +
      "HDD/SSD: " + (e.field("hdd/ssd2") || "Not specified") + "\n" +
      "Graphics Card: " + (e.field("graphics card2") || "Not specified") + "\n" +
      "Wifi: " + (e.field("wifi2") || "Not specified") + "\n" +
      "OS: " + (e.field("os version2") || "Not specified") + "\n" +
      line1 + "\n" +
      "Subtotal: $" + parseFloat(e.field("subtotal 2") || 0).toFixed(2) + "\n" +
      "Shipping: $" + parseFloat(e.field("shipping.") || 0).toFixed(2) + "\n" +
      "Labour: $" + parseFloat(e.field("labour.") || 0).toFixed(2) + "\n" +
      "Extras: $" + parseFloat(e.field("extras.") || 0).toFixed(2) + "\n" +
      "Total: " + (e.field("gt 2") || "Not specified") +
      line1 + "\n" + "\n" +
      (
        e.field("Office") || e.field("printer") || e.field("other")
          ? (
              ...
              line + "\n" +
              (e.field("Office")
                ? "Microsoft Office:\n" + e.field("Office") + " $" + parseFloat(e.field("office sell price") || 0).toFixed(2) + "\n"
                : "") +
              (e.field("printer")
                ? "Printer:\n" + e.field("printer") + " $" + parseFloat(e.field("printer sell price") || 0).toFixed(2) + "\n"
                : "") +
              (e.field("other")
                ? "Other:\n" + e.field("other") + " $" + parseFloat(e.field("other sell price") || 0).toFixed(2) + "\n"
                : "")
            )
          : ""
      ) +
...
if (engine === "Emai Quitel" && e.field("email")) {
